...
--*/
{
    ...
    // call once to count
    //
    SetupScanFileQueue(queueHandle,SPQ_SCAN_USE_CALLBACK,NULL,(PSP_FILE_CALLBACK_W)DumpDeviceDriversCallback,&count,&scanResult);
    Padding(1);
    ...
    //
    SetupScanFileQueue(queueHandle,SPQ_SCAN_USE_CALLBACK,NULL,(PSP_FILE_CALLBACK_W)DumpDeviceDriversCallback,NULL,&scanResult);
